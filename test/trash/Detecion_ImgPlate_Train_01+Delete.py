'główny: responsywne labele+wycinanie tablic+biały pasek'
...
extension_width = 500  # Szerokość dodatkowego białego paska
...
if detected:
    ...
    # Wyświetl rozszerzony obraz
    cv2.imshow('Detected Image with Extension', extended_image)
    cv2.waitKey(0)
